...
public class ResourceCentreTest {
	...
	public void testRetrieveAllChromebook() {
		...
		testOutput = String.format("%-10s %-30s %-10s\n","CB0011", "My Google Chromebook 1s6", "Mac OS");
	...
	public void testDoReturnChromebook() {
		...
		assertTrue("Test that CB0011 is now avaliable.", chromebookList.get(0).getIsAvailable());
		...
		//Test Case 3: Return an item that does not exist
		isReturned = ResourceCentre.doReturnChromebook(chromebookList, "CB0013");
		assertFalse("Test that the return of CB--13 fails.", isReturned);
